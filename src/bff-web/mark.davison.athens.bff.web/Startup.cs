...
public class Startup
{
    ...
    public void ConfigureServices(IServiceCollection services)
    {
        ...
        services.AddTransient<ICustomZenoAuthenticationActions, AthensCustomZenoAuthenticationActions>();
        ...
        services.AddSingleton<IHttpRepository>(_ =>
        {
            ...
            return new AthensHttpRepository(AppSettings.API_ORIGIN, options);
        });
